	...
	<%@page import="org.renaultleat.network.QuorumStorage" %>
		 ...
		 */
					...
					async function gettxData() {
						let txprocessedresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getProcessedTPS", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
						...
						let partialtxprocessedresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getPartialTPS", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
						...
						let txfinalisedresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getFinalisedTPS", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
					...
					async function getconsensusData() {
						let mxproposeresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getProposeRate", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
						...
						let mxcommitresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getCommitRate", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
						...
						let mxfinaliseresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getFinaliseRate", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
						...
						let mxheartbeatresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getHeartBeatRate", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
						...
						let mxquorumresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getQuorumRate", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
						...
						let mxroundchangeresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getRoundChangeRate", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
