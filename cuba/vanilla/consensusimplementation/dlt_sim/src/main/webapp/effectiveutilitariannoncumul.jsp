			...
			<body>
				...
				<script type="text/javascript">
					...
					async function geteffectivescoreData() {
						let utilitarianeffectivescoreresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianEffectiveScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
					...
					async function getclassificationData() {
						let utilitarianclassificationresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianClassificationGrid", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
					...
					async function getquorumsuspensionData() {
						let utilitarianquorumsuspensionresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getQuorumSuspensionGrid", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
