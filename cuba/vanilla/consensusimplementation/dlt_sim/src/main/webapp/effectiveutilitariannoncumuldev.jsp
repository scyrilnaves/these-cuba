			...
			<body>
				...
				<script type="text/javascript">
					...
					async function geteffectivescoreData() {
						let utilitarianeffectivescoreresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianEffectiveScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
