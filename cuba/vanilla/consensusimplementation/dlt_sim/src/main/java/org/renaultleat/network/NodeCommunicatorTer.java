...
public class NodeCommunicatorTer extends Thread {
    ...
    public NodeCommunicatorTer(String port, Blockchain blockchain) throws NumberFormatException, IOException {
    ...
    public void run() {
        try {
            while (true) {
                NodeCommunicatorThreadTer nodeCommunicatorThreadTer = new NodeCommunicatorThreadTer(
                        serverSocket.accept(), this);
                nodeCommunicatorThreads.add(nodeCommunicatorThreadTer);
                nodeCommunicatorThreadTer.start();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
