...
public class CAPSEOBFTDemTransactionMessageHandlerSec extends Thread {
                ...
                try {
                    ...
                    if (!PrivacyStorage.isPrivacy() || (PrivacyStorage.isPrivacy()
                        ...
                        if (!this.transactionPool.getConfirmedTransactionIds().contains(inputTransaction.getId())
                            ...
                            try {
                                this.nodeCommunicatorSec.rebroadCastTransaction(jsonObject);
                            } catch (Exception e) {
    ...
    public CAPSEOBFTDemTransactionMessageHandlerSec(BlockingQueue<JSONObject> intransactionBlockingQueue,
