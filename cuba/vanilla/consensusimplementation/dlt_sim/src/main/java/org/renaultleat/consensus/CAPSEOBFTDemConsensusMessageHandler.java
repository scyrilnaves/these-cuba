                                                            ...
                                                            if (!this.capSEOBFTDemMessagePool
                                                                ...
                                                                try {
                                                                    ...
                                                                    if (NodeProperty.getnodeBehavior() == 1) {
                                                                        ...
                                                                        // .sleep(NodeProperty.latency + 50);
                                                                    }
                                                                    if (NodeProperty.getnodeBehavior() == 2
                                                                            || NodeProperty.getnodeBehavior() == 3) {
                                                                        // TimeUnit.MILLISECONDS
                                                                        // .sleep(NodeProperty.latency + 100);
                                                                    }
                                                ...
                                                if (quorumMessageforSubEpoch
                                                    ...
                                                    if (quorumId == quorumMessageforSubEpoch
...

                                                        {
                                                            ...
                                                            if (inPartialBlock.getValidity()) {
                                                                if (!this.blockchain
                                                                        .partialBlockFilled(inPartialBlock)) {
                                                                    if (!this.capSEOBFTDemMessagePool
                                                                        ...
                                                                        if (this.capSEOBFTDemMessagePool.commitMessagePool
                                                                            ...
                                                                            // System.out.println("COMMITVALID1" +
                                                                            // "major:"
                                                                            // + inPartialBlock.getMajorBlocknumber()
                                                                            // + "minor:"
                                                                            // + inPartialBlock.getMinorBlocknumber());
                                                                            ...
                                                                            if (inPartialBlock.getProposer()
                                                                                ...
                                                                                // Update the Commit Voters for the
                                                                                // Partial
                                                                                // Block
                                                                                inPartialBlock
                                                                                        .setCommitMessageValidators(
                                                                                ...
                                                                                this.capSEOBFTDemMessagePool
                                                                                        .addFinaliseMessage(
                                                                                                inPartialBlock);
                                                                                try {
                                                                                    // BroadCast Finalise Message for
                                                                                    // the
                                                                                    // Partial Block
                                                                                    ...
                                                                                    // + inPartialBlock
                                                                                    // .getMinorBlocknumber());
                                                                                    this.broadCastFinalise(
                                                                                            inPartialBlock);
                                                                                } catch (Exception e) {
                                                                                    // TODO Auto-generated catch block
                                                                                    e.printStackTrace();
                                                                                }
                                                                                // Add the finalised Block to the
                                                                                // ephemeral
                                                                                // chain
                                                                                // If TRUE: the partial blocks
                                                                                // completely
                                                                                // fills
                                                                                // the required
                                                                                // block
