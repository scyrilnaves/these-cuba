...
public class CAPSEOBFTProperty {
    ...
    // Recovery Propoerty
    public static int upperindex = 100;
    public static int secondupperindex = 200;
    public static int firstrangeupperindex = 50;
    public static int firstrangelowerindex = 100;
    public static int secondrangeupperindex = 150;
    public static int secondrangelowerindex = 200;
    public static int thirdrangeupperindex = 250;
    public static int thirdrangelowerindex = 300;
    public static int fourthrangeupperindex = 350;
    public static int fourthrangelowerindex = 400;
