                                                ...
                                                if (quorumMessageforSubEpoch
                                                    ...
                                                    if (quorumMessageforSubEpoch
                                                        ...
                                                        Block ephemeralBlock = this.blockchain.getEphemeralChain()
                                                                .get(nextIndex);
                                                        ValueRange firstrange = java.time.temporal.ValueRange.of(
                                                                CAPSEOBFTProperty.firstrangeupperindex,
                                                                CAPSEOBFTProperty.firstrangelowerindex);
                                                        ValueRange secondrange = java.time.temporal.ValueRange.of(
                                                                CAPSEOBFTProperty.secondrangeupperindex,
                                                                CAPSEOBFTProperty.secondrangelowerindex);
                                                        ValueRange thirdrange = java.time.temporal.ValueRange.of(
                                                                CAPSEOBFTProperty.thirdrangeupperindex,
                                                                CAPSEOBFTProperty.thirdrangelowerindex);
                                                        ValueRange fourthrange = java.time.temporal.ValueRange.of(
                                                        ...
                                                        if (NodeProperty.getnodeBehavior() == 2) {
                                                        ...
                                                        } else if (NodeProperty.getnodeBehavior() == 4
                                                                && this.blockchain.getChain()
                                                                        .size() < CAPSEOBFTProperty.upperindex) {
                                                            // System.out
                                                            // .println("4444444444" + ":::" + this.blockchain
                                                            ...
                                                            block = this.blockchain.finalisedMaliciousFullBlock(wallet,
                                                                    ...
                                                                    fullBlockProposerIndex,
                                                                    CAPSEOBFTProperty.normalProposal);
                                                        } else if (NodeProperty.getnodeBehavior() == 5
                                                                && this.blockchain.getChain()
                                                                        .size() < CAPSEOBFTProperty.secondupperindex) {
                                                            // System.out
                                                            // .println("4444444444" + ":::" + this.blockchain
                                                            // .getChain().lastKey().intValue());
                                                            // Malicious Behaviour
                                                            block = this.blockchain.finalisedMaliciousFullBlock(wallet,
                                                                    ...
                                                                    fullBlockProposerIndex,
                                                                    CAPSEOBFTProperty.normalProposal);
                                                        } else if (NodeProperty.getnodeBehavior() == 6
                                                                && (firstrange.isValidIntValue(
                                                                        ...
                                                                        || fourthrange.isValidIntValue(this.blockchain
                                                                                .getChain().size()))) {
                                                            // System.out.println("5555555555" + ":::" + this.blockchain
                                                            // .getChain().lastKey().intValue());
                                                            // Malicious Behaviour
                                                            block = this.blockchain.finalisedMaliciousFullBlock(wallet,
                                                                    nextIndex,
