			...
			<body>
				...
				<script type="text/javascript">
					...
					async function getmissedcommitscoreData() {
						let utilitarianmissedcommitresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedCommitScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
					...
					async function getmaliciousscoreData() {
						let utilitarianmaliciousresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMaliciousScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
					...
					async function getmissedheartbeatscoreData() {
						let utilitarianmissedheartbeatresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedHeartBeatScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
					...
					async function getmissedblockproposalscoreData() {
						let utilitarianmissedblockproposalresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedBlockProposalScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json' } });
