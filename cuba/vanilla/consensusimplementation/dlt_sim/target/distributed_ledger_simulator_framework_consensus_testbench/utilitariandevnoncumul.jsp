			...
			<body>
				...
				<script type="text/javascript">
					...
					async function getcommitscoreData() {
						let utilitariancommitresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianCommitScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json'}});
					...
					async function getheartbeatscoreData() {
						let utilitarianheartbeatresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianHeartBeatScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json'}});
					...
					async function getinterblockscoreData() {
						let utilitarianinterblockresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianInterBlockTimeCoefficientGrid", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json'}});
					...
					async function getblockproposalscoreData() {
						let utilitarianblockproposalresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianBlockProposalScoreGrid", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json'}});
