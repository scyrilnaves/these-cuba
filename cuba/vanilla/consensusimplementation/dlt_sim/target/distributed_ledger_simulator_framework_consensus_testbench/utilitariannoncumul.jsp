			...
			<body>
				...
				<script type="text/javascript">
					...
					async function getcommitscoreData() {
						let utilitariancommitresponse = await fetch("http://" + ipurl +"/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianCommitScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json'}});
					...
					async function getheartbeatscoreData() {
						let utilitarianheartbeatresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianHeartBeatScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json'}});
					...
					async function getinterblockscoreData() {
						let utilitarianinterblockresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianInterBlockTimeCoefficientGrid", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json'}});
					...
					async function getblockproposalscoreData() {
						let utilitarianblockproposalresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianBlockProposalScoreGridNonCumul", { method: "GET", mode: 'cors', headers: { 'Content-Type': 'application/json'}});
