...
heartbeat=5000
totalquorums=5
epochthreshold=50000
# MORE IMPORTANT!!
subepochthreshold=25000
privacyid=1
      ...
      for nwlaten in "${latency[@]}"; do
        for blsize in "${blocksize[@]}"; do
          ...
          for endpoint in "${endpoints[@]}"; do
            ...
            #Commit Score
            curl -s -o results/$testtype/$endpoint/commitscorenoncumul.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianCommitScoreGrid
            # Heart Beat Score
            curl -s -o results/$testtype/$endpoint/heartbeatscorenoncumul.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianHeartBeatScoreGrid
            # Block Time Coefficient
            curl -s -o results/$testtype/$endpoint/interblocktime.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianInterBlockTimeCoefficientGrid
            #Block Proposal
            curl -s -o results/$testtype/$endpoint/blockproposalnoncumul.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianBlockProposalScoreGrid

            #------------------
            #Effective Utilitarian Part:
            #Effective Score
            curl -s -o results/$testtype/$endpoint/effectivescorenoncumul.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianEffectiveScoreGrid
            #Classification data
            curl -s -o results/$testtype/$endpoint/classification.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianClassificationGrid
            #Suspension data
            curl -s -o results/$testtype/$endpoint/suspension.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getQuorumSuspensionGrid
            ...
            #Non Utilitarian Part:
            #Missed Commit
            curl -s -o results/$testtype/$endpoint/missedcommitnoncumul.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedCommitScoreGrid
            #Malicious Score
            curl -s -o results/$testtype/$endpoint/maliciousscorenoncumul.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMaliciousScoreGrid
            #Missed Heart Beat
            curl -s -o results/$testtype/$endpoint/missedheartbeatnoncumul.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedHeartBeatScoreGrid
            #Missed Block Proposal
            curl -s -o results/$testtype/$endpoint/missedblockproposalnoncumul.json http://$urlcontext/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedBlockProposalScoreGrid
