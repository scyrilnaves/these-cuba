			...
			<body>
				...
				<script type="text/javascript">
					...
					async function getcommitscoreData() {
						let utilitariancommitresponse = await fetch("http://" + ipurl +"/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianCommitScoreGridNonCumul");
					...
					async function getheartbeatscoreData() {
						let utilitarianheartbeatresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianHeartBeatScoreGridNonCumul");
					...
					async function getinterblockscoreData() {
						let utilitarianinterblockresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianInterBlockTimeCoefficientGrid");
					...
					async function getblockproposalscoreData() {
						let utilitarianblockproposalresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianBlockProposalScoreGridNonCumul");
