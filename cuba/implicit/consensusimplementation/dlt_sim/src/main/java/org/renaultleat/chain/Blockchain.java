...
public class Blockchain {
    ...
    public PartialBlock getPartialBlockFilled(PartialBlock inPartialblock) {
        ...
        if (this.ephemeralchain.containsKey(majorindex)
                && this.ephemeralchain.get(majorindex).getPartialBlockMap().containsKey(minorindex)) {
            partialBlock = this.ephemeralchain.get(majorindex).getPartialBlockMap().get(minorindex);
            if (partialBlock.isFinalised()) {
                return partialBlock;
            }
        }
        // Ephemeral Chain
