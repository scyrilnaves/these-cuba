	...
	<%@page import="org.renaultleat.network.QuorumStorage" %>
		<%@page import="org.renaultleat.node.Wallet" %>
			...
			<body>
				...
				<br>
				<h3>Effective utilitarian Score - Non cumulative</h3>
				...
				<script type="text/javascript">
					...
					async function geteffectivescoreData() {
						let utilitarianeffectivescoreresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianEffectiveScoreGridNonCumul");
					...
					async function getclassificationData() {
						let utilitarianclassificationresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianClassificationGrid");
					...
					async function getquorumsuspensionData() {
						let utilitarianquorumsuspensionresponse = await fetch("http://localhost:" + port + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getQuorumSuspensionGrid");
