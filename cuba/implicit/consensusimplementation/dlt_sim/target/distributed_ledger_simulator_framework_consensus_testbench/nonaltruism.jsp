			...
			<body>
				...
				<script type="text/javascript">
					...
					async function getmissedcommitscoreData() {
						let utilitarianmissedcommitresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedCommitScoreGrid");
					...
					async function getmaliciousscoreData() {
						let utilitarianmaliciousresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMaliciousScoreGrid");
					...
					async function getmissedheartbeatscoreData() {
						let utilitarianmissedheartbeatresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedHeartBeatScoreGrid");
					...
					async function getmissedblockproposalscoreData() {
						let utilitarianmissedblockproposalresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianMissedBlockProposalScoreGrid");
