			...
			<body>
				...
				<script type="text/javascript">
					...
					async function geteffectivescoreData() {
						let utilitarianeffectivescoreresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianEffectiveScoreGrid");
