			...
			<body>
				...
				<script type="text/javascript">
					...
					async function getcommitscoreData() {
						let utilitariancommitresponse = await fetch("http://" + ipurl +"/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianCommitScoreGrid");
					...
					async function getheartbeatscoreData() {
						let utilitarianheartbeatresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianHeartBeatScoreGrid");
					...
					async function getblockproposalscoreData() {
						let utilitarianblockproposalresponse = await fetch("http://" + ipurl + "/distributed_ledger_simulator_framework_consensus_testbench/rest/simulatorcontroller/getUtilitarianBlockProposalScoreGrid");
